...
echo "FETH=$FETH" >> deployed.prod.env
...
echo "FHBTC=$FHBTC" >> deployed.prod.env
...
echo "FWBTC=$FWBTC" >> deployed.prod.env
...
echo "FUSDT=$FUSDT" >> deployed.prod.env
...
echo "FUSDC=$FUSDC" >> deployed.prod.env
...
echo "FBUSD=$FBUSD" >> deployed.prod.env
...
echo "FHUSD=$FHUSD" >> deployed.prod.env
...
echo "FDAI=$FDAI" >> deployed.prod.env
...
echo "FFOR=$FFOR" >> deployed.prod.env
...
echo "FBNB=$FBNB" >> deployed.prod.env
...
echo "FHT=$FHT" >> deployed.prod.env
...
echo "FOKB=$FOKB" >> deployed.prod.env
...
# echo "FYUSD=$FYUSD" >> deployed.prod.env
...
# echo "FYWETH=$FYWETH" >> deployed.prod.env
...
# echo "FPAX=$FPAX" >> deployed.prod.env
...
# echo "FTUSD=$FTUSD" >> deployed.prod.env
...
echo "REWARD_POOL=$REWARD_POOL" >> deployed.prod.env
