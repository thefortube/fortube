...
echo "FETH=$FETH" >> deployed.qa.env
...
echo "FHBTC=$FHBTC" >> deployed.qa.env
...
echo "FWBTC=$FWBTC" >> deployed.qa.env
...
echo "FUSDT=$FUSDT" >> deployed.qa.env
...
echo "FUSDC=$FUSDC" >> deployed.qa.env
...
echo "FBUSD=$FBUSD" >> deployed.qa.env
...
echo "FHUSD=$FHUSD" >> deployed.qa.env
...
echo "FDAI=$FDAI" >> deployed.qa.env
...
echo "FFOR=$FFOR" >> deployed.qa.env
...
echo "FBNB=$FBNB" >> deployed.qa.env
...
echo "FOKB=$FOKB" >> deployed.qa.env
...
# echo "FYUSD=$FYUSD" >> deployed.qa.env
...
# echo "FYWETH=$FYWETH" >> deployed.qa.env
...
# echo "FPAX=$FPAX" >> deployed.qa.env
...
# echo "FTUSD=$FTUSD" >> deployed.qa.env
...
echo "REWARD_POOL=$REWARD_POOL" >> deployed.qa.env
